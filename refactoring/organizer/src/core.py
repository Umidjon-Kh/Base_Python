...
class Organizer:
    ...
    And Organizes them by extension type
    Uses RuleManager to set extentsion for folder
    """

    __slots__ = ('source', 'rule_manager', 'dest', 'recursive', 'dry_run', 'clean', 'stats')
    ...
    def __init__(
        ...
        self.stats = {'moved': 0, 'removed': 0, 'skipped': 0, 'errors': 0}

    def organize(self) -> None:
        """Running process of file organizing"""
        # 1.Action: Checking source path exists or not and is dir or not
